...
class ArrayList(List):
    ...
    def get(self, i : int) -> object:
        ...
        '''
        if i < 0 or i >= self.n:
            raise IndexError("index i cant be greater than or equal to number of elements nor be less than 0 ")
    ...
    def add(self, i : int, x : object) :
        ...
        '''
        if i < 0 or i > self.n:
            raise IndexError("Can't add at an index that is less than the array, or greater than the array")
